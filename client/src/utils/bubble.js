export function bubble() {
	...
	function drawStuff() {
		...
		function drawFrame() {
			...
			sphere3.x = canvas.width/2 + Math.sin(angle3) * 220;
			sphere3.y = canvas.height/2 -40 + Math.cos(angle3) * 150;
			...
			sphere.y = canvas.height/2 -200 + Math.cos(angle) * radius;
			sphere.x = canvas.width/2 + Math.sin(angle) * 150;
			angle += speed;
			angle2 += speed2;
			angle3 += speed3;
			sphere.draw(context);
